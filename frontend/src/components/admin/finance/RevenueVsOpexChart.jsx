...
export default function RevenueVsOpexChart({ revenueOpexData = [] }) {
  return (
      ...
      <div className="w-full h-72 md:h-80 relative">
        {revenueOpexData.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={revenueOpexData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
