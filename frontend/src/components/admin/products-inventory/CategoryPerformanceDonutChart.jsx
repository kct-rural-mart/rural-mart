...
import { PRODUCT_CATEGORY_PERFORMANCE } from '../../../lib/newPages/mockData'
...
export default function CategoryPerformanceDonutChart() {
  const totalRevenue = PRODUCT_CATEGORY_PERFORMANCE.reduce((sum, d) => sum + d.value, 0)
          ...
          <>
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Pie data={PRODUCT_CATEGORY_PERFORMANCE} cx="50%" cy="45%" innerRadius={62} outerRadius={98} paddingAngle={4} dataKey="value" labelLine={false} label={renderCustomizedLabel}>
            ...
            <div className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none">
              ...
              <span className="text-lg font-black text-brand-text font-mono">₹{(totalRevenue / 10000000).toFixed(2)}Cr</span>
            </div>
          </>
        )}
      </div>
